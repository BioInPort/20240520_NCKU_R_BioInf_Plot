...
# data_csv <- read.csv("D:/Dropbox/##_GitHub/##_BioInPort/20240520_NCKU_R_BioInf_Plot/Demo_20240519/20240519114525_data_Scatterplot_Basic.csv")
## Load data from TSV file
# data_tsv <- read.table("D:/Dropbox/##_GitHub/##_BioInPort/20240520_NCKU_R_BioInf_Plot/Demo_20240519/20240519114525_data_Scatterplot_Basic.tsv", sep = "\t", header = TRUE)

# Load data from CSV file
data <- read.csv("D:/Dropbox/##_GitHub/##_BioInPort/20240520_NCKU_R_BioInf_Plot/Demo_20240519/20240519114525_data_Scatterplot_Basic.csv")
